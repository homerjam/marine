...
$config->styles->prepend($config->urls->adminTemplates . "styles/main.css?v=3");
$config->styles->append($config->urls->adminTemplates . "styles/inputfields.css");
$config->styles->append($config->urls->adminTemplates . "styles/ui.css?v=3");
$config->styles->append($config->urls->adminTemplates . "styles/jquery.sidr.dark.css");
...
$config->scripts->append($config->urls->adminTemplates . "scripts/jquery.sidr.min.js");
	...
	<?php if($bodyClass != "modal"){?>
		<?php if(!$user->isGuest()): ?>
			...
			<ul id="breadcrumb" class="nav">
                ...
                <li><a id="side-menu" href="#sidr" style="text-decoration: none;"><span style="font-size: 21px;">≡</span></a></li>
